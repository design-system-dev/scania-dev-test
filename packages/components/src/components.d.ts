...
declare module '@stencil/core' {
    export namespace JSX {
        interface IntrinsicElements {
            'driver-evaluation-page': LocalJSX.DriverEvaluationPage &
                JSXBase.HTMLAttributes<HTMLDriverEvaluationPageElement>;
            'dropdown-component': LocalJSX.DropdownComponent &
                JSXBase.HTMLAttributes<HTMLDropdownComponentElement>;
            'table-component': LocalJSX.TableComponent &
                JSXBase.HTMLAttributes<HTMLTableComponentElement>;
            'table-row-component': LocalJSX.TableRowComponent &
                JSXBase.HTMLAttributes<HTMLTableRowComponentElement>;
            'text-component': LocalJSX.TextComponent &
                JSXBase.HTMLAttributes<HTMLTextComponentElement>;
        }
    }
}
